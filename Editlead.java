...
public static void main(String[] args) throws InterruptedException  {
	...
	driver.findElementByXPath("(//input[@name='companyName'])[2]").sendKeys("fttrrgr");
	driver.findElementByXPath("(//input[@name='firstName'])[3]").sendKeys("pooja");
	driver.findElementByXPath("(//input[@name='lastName'])[3]").sendKeys("v");
	...
	driver.findElementByXPath("(//input[@name='companyName'])[2]").sendKeys("xxyyzz");
